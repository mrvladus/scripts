...
# Cleanup
sudo apt autopurge snapd gnome-{characters,power-manager,startup-applications} fonts-{beng,g*,k*,la*,lk*,lo*,na*,or*,p*,s*,t*,y*} -y
rm -rf ./snap
